Dict = {
    ...
    "PROJECT_COMPLIE":"x557_h807_b1",
    "BASE_PATH":"/mnt/SwVer4/X557_H807/B1_BOM/MP",
    "MEMORY":["#define BOARD_ID MT6580_EVB","#define CS_PART_NUMBER[0] KMFE10012M_B214","#define CS_PART_NUMBER[1] KMQ820013M_B419","#define CS_PART_NUMBER[2] KMF820012M_B305","#define CS_PART_NUMBER[3] 16EMCP08_EL3BT527"],
