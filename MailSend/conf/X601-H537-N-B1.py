Dict = {
    ...
    "VERSION_BASE":"X601-H537B1",
    "SNAPSHOT_DIRECTORY":"x601_h537_b1_tag",
    ...
    "PROJECT_COMPLIE":"x601_h537_b1",
    "BASE_PATH":"/mnt/SwVer4/X601-H537-N/B1_BOM/DailyBuild",
    ...
    "CC_MAIL_LIST":["yuanchun.yao@reallytek.com","ptyfbptrjb@reallytek.com","ruanjianxiangmuguanlibu@reallytek.com","ruanjianyibu@reallytek.com","ptyfbgxb@reallytek.com","changkun.wu@reallytek.com","yongrong.wang@reallytek.com","zhen.wang@reallytek.com","dongming.lu@reallytek.com","weicheng.wang@reallytek.com"]
}
def getInfo(pj_info):
    pj_info=pj_info
