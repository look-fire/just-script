...
Dict = {
    ...
    "PROJECT_JIRA_URL" : "http://192.168.1.85:8080/browse/WSLTEHHSWL/?selectedTab=com.atlassian.jira.jira-projects-plugin:summary-panel",
    "PLATFORM":"MTK6753",
    ...
    "PROJECT_COMPLIE":"w3lte_d1",
    "BASE_PATH":u"/mnt/SwVer4/北京合作项目/W3LTE-H356/D1_BOM/GMS",
    "MEMORY":["#define BOARD_ID-----MT6735_EVB","#define CS_PART_NUMBER[0]-----KMQ820013M_B419","#define CS_PART_NUMBER[1]-----KMQ7X000SA_B315","#define CS_PART_NUMBER[2]-----KMF720012M_B214","#define CS_PART_NUMBER[3]-----08EMCP08_EL3BT227","#define CS_PART_NUMBER[4]-----KMFNX0012M_B214","//#define CS_PART_NUMBER[0]-----H9TP64A8JDMCPR_KGM","//#define CS_PART_NUMBER[4]-----H9TP32A4GDDCPR_KGM"],
