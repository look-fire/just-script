...
Dict = {
    ...
    "PROJECT_COMPLIE":"w3_b1",
    "BASE_PATH":u"/mnt/SwVer4/北京合作项目/W3-H806/NEW_BASE/B1_BOM/GMS",
    "MEMORY":["#define BOARD_ID-----MT6580_EVB","#define CS_PART_NUMBER[0]-----KMF720012M_B214","#define CS_PART_NUMBER[1]-----H9TP64A8JDMCPR_KGM","#define CS_PART_NUMBER[2]-----KHN6405FS-HKc1","#define CS_PART_NUMBER[3]-----08EMCP08_EL3BT227"],
    "TO_MAIL_LIST":["lu.zheng@reallytek.com","ruanjianceshibu@reallytek.com"],
    "CC_MAIL_LIST":["ptyfbgxb@reallytek.com","ptyfbptrjb@reallytek.com","ruanjianerbu@reallytek.com","ruanjianxiangmuguanlibu@reallytek.com","yingjianbuceshi@reallytek.com","changkun.wu@reallytek.com","xiangfu.dang@transage.cn","ruijie.zhang@transage.cn","jinlei.mo@transage.cn","weifeng.niu@transage.cn","jianjun.han@transage.cn","yuebin.zhang@transage.cn","junfeng.shi@transage.cn","qing.yang@transage.cn","qing.yang@transage.cn","haitao.wang@transage.cn","daqi.zhang@transage.cn","yongrong.wang@reallytek.com","haobin.zhang@reallytek.com","zhen.wang@reallytek.com"]}
