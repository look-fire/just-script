...
Dict = {
    ...
    "PROJECT_COMPLIE":"cx_h501_c1",
    "BASE_PATH":u"/mnt/SwVer4/CX_H501_N/CX_H501_HiOS/DAILY/C1_BOM/",
    "MEMORY":["#define BOARD_ID-----MT6755_EVB","#define BOARD_ID MT6755_EVB","#define CS_PART_NUMBER[0] KMRX1000BM_B614","#define CS_PART_NUMBER[1] KMRE1000BM_B512","#define CS_PART_NUMBER[2] H9TQ17ADFTACUR_KUM"],
    "TO_MAIL_LIST":["yuanchun.yao@reallytek.com","shenjiang.he@reallytek.com","ruanjianceshibu@reallytek.com"],
