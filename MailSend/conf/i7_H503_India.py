...
Dict = {
    ...
    "BASE_PATH":"/mnt/SwVer4/i7/i7_H503_India/A1_BOM/DAILY",
    "MEMORY":["#define CS_PART_NUMBER[0] KMRX10014M_B614","#define CS_PART_NUMBER[1] H9TQ26ACLTMCUR_KUM"],
    "TO_MAIL_LIST":["xywrjcsb@reallytek.com","yingjianbuceshi@reallytek.com","ptyfbgxb@reallytek.com","ruanjianxiangmuguanlibu@reallytek.com","ptyfbptrjb@reallytek.com","xywxmglb@reallytek.com"],
